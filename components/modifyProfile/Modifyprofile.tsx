             ...
             <form>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="col-span-full">
                        ...
                        <div className="mt-2">
                        <textarea id="about" name="about"  className="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6" />
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <fieldset>
                        ...
                        <div className="flex items-center gap-x-3">
                            <input  name="push-notifications" type="radio" className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
