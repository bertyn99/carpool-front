  ...
  return (
    <>
      ...
      <div className='w-full flex justify-center py-10'>
        <a href='#avantages'>
          <svg className="animate-bounce w-10 h-10 mx-2 my-2 text-dark-green " fill="" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
